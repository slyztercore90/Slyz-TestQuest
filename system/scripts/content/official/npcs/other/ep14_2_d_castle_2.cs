...
public class Ep142DCastle2NpcScript : GeneralScript
{
	public override void Load()
	{
		...
		//-------------------------------------------------------------------------
		AddNpc(4, 154065, "Magic Association Assembly Hall", "ep14_2_d_castle_2", 86.00278, 68.03178, 635.9998, 90, "EP14_2_DCASLTE2_PORTAL", "", "");
		
		// [Great Royal General] {nl} Ramin
		//-------------------------------------------------------------------------
		AddNpc(5, 150287, "[Great Royal General] {nl} Ramin", "ep14_2_d_castle_2", 188.8989, 95.67754, -331.3, 93, "EP14_2_2_LAMIN1", "", "");
		
		// Pajauta
		//-------------------------------------------------------------------------
		AddNpc(6, 154120, "Pajauta", "ep14_2_d_castle_2", 213.9028, 95.67754, -388.2869, 142, "EP14_2_2_PAJAUTA1", "", "");
		...
		// Pajauta
		//-------------------------------------------------------------------------
		AddNpc(11, 154120, "Pajauta", "ep14_2_d_castle_2", -962.5208, 68.03178, 1126.418, 110, "EP14_2_2_PAJAUTA2", "", "");
		
		// [Great Royal General] {nl} Ramin
		//-------------------------------------------------------------------------
		AddNpc(12, 150287, "[Great Royal General] {nl} Ramin", "ep14_2_d_castle_2", -968.8201, 68.03178, 1180.229, 46, "EP14_2_2_LAMIN2", "", "");
		...
		//  
		//-------------------------------------------------------------------------
		AddNpc(24, 154046, " ", "ep14_2_d_castle_2", 90.9, 68.13, 539.86, 90, "BAUBAS_GO_GUILDMISSION", "BAUBAS_GO_GUILDMISSION", "");
	}
}
