...
public class Quest60152Script : QuestScript
{
	protected override void Load()
	{
		...
		AddObjective("kill0", "Kill 3 Leafly(s)", new KillObjective(47532, 3));
		AddObjective("kill1", "Kill 4 Spion Archer(s)", new KillObjective(57609, 4));
		AddObjective("kill2", "Kill 2 Mali(s)", new KillObjective(47529, 2));
