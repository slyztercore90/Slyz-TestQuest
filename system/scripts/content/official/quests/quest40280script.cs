...
//--- Description -----------------------------------------------------------
// Quest to Investigate the suspicious area.
//---------------------------------------------------------------------------
...
[QuestScript(40280)]
public class Quest40280Script : QuestScript
{
	protected override void Load()
	{
		SetId(40280);
		SetName("Unexpected Discovery (1)");
		SetDescription("Investigate the suspicious area");
		...
		AddDialogHook("FARM47_HEAD_D", "BeforeStart", BeforeStart);
