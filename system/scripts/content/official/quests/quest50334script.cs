...
public class Quest50334Script : QuestScript
{
	protected override void Load()
	{
		...
		SetTrack("SProgress", "ESuccess", "WTREES22_2_SQ8_TRACK", "None");
	...
	private async Task<HookResult> BeforeEnd(Dialog dialog)
	{
		...
		if (character.Quests.IsCompletable(this.QuestId))
		{
			...
			dialog.AddonMessage("NOTICE_Dm_Clear", "The demons guarding the place have been taken care of.{nl}Go to Narvas Temple through Izoliacjia Plateau.");
