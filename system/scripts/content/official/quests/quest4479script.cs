...
public class Quest4479Script : QuestScript
{
	protected override void Load()
	{
		...
		SetTrack("SProgress", "ESuccess", "MINE_1_CRYSTAL_18_TRACK", "m_boss_d");
	...
	public override void OnStart(Character character, Quest quest)
	{
		...
		dialog.AddonMessage("NOTICE_Dm_Clear", "The Mine Compass is pointing at District 6{nl}Go to District 6 and look for the part");
