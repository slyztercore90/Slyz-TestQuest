...
public class Quest8440Script : QuestScript
{
	protected override void Load()
	{
		...
		SetTrack("SProgress", "ESuccess", "ZACHA3F_SQ_03_TRACK", 4000);

		AddPrerequisite(new CompletedPrerequisite("ZACHA3F_SQ_02"));
		AddPrerequisite(new LevelPrerequisite(88));

		AddObjective("kill0", "Kill 1 Royal Mausoleum Stone Lantern", new KillObjective(47253, 1));
	...
	public override void OnStart(Character character, Quest quest)
	{
		...
		dialog.AddonMessage("NOTICE_Dm_Clear", "This wasn't the only stone lantern{nl}Find the other corrupted stone lanterns and destroy them");
	}
}
