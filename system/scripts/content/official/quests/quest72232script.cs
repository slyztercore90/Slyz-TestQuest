...
public class Quest72232Script : QuestScript
{
	protected override void Load()
	{
		...
		SetTrack("SSuccess", "ESuccess", "CASTLE95_MAIN03_TRACK", "None");
	...
	private async Task<HookResult> BeforeEnd(Dialog dialog)
	{
		...
		if (character.Quests.IsCompletable(this.QuestId))
		{
			...
			dialog.AddonMessage("NOTICE_Dm_Clear", "Investigate the Training Grounds obelisk as instructed in Antanina's note!");
