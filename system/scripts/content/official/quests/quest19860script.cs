...
public class Quest19860Script : QuestScript
{
	protected override void Load()
	{
		...
		SetTrack("SProgress", "ESuccess", "PILGRIM51_SQ_10_TRACK", "m_boss_a");

		AddPrerequisite(new LevelPrerequisite(129));

		AddObjective("kill0", "Kill 1 Ironbaum", new KillObjective(57299, 1));
	...
	private async Task<HookResult> BeforeEnd(Dialog dialog)
	{
		...
		if (character.Quests.IsCompletable(this.QuestId))
		{
			...
			dialog.AddonMessage("NOTICE_Dm_Clear", "You've defeated Ironbaum that was going after the pilgrim! Now, you will receive the blessing from the sanctum.");
