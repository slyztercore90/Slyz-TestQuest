...
public class Quest8386Script : QuestScript
{
	protected override void Load()
	{
		...
		SetTrack("SProgress", "ESuccess", "ZACHA4F_MQ_04_TRACK", 4000);
	...
	private async Task<HookResult> BeforeEnd(Dialog dialog)
	{
		...
		if (character.Quests.IsCompletable(this.QuestId))
		{
			...
			dialog.AddonMessage("NOTICE_Dm_Clear", "It seems that the Royal Mausoleum will collapse soon!{nl}Stop the Guardians attacking it!");
			return HookResult.Break;
		}
