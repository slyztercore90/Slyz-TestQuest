...
[TrackScript("CASTLE95_MAIN05_BEFORE_TRACK")]
public class CASTLE95MAIN05BEFORETRACK : TrackScript
{
	protected override void Load()
	{
		SetId("CASTLE95_MAIN05_BEFORE_TRACK");
		//SetMap("f_castle_95");
	...
	public override async Task OnProgress(Character character, Track track, int frame)
	{
		...
		{
			case 8:
				character.AddonMessage("NOTICE_Dm_Clear", "Place the colored shards on the pedestal in the correct order!", 5);
				break;
			case 9:
				//DRT_PLAY_MGAME("CASTLE95_MAIN05_MINI");
				break;
			default:
