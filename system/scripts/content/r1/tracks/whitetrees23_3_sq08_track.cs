...
[TrackScript("WHITETREES23_3_SQ08_TRACK")]
public class WHITETREES233SQ08TRACK : TrackScript
{
	protected override void Load()
	{
		SetId("WHITETREES23_3_SQ08_TRACK");
		//SetMap("None");
	...
	public override IActor[] OnStart(Character character, Track track)
	{
		...
		character.Movement.MoveTo(new Position(83.63677f, 160.1254f, 514.508f));
		actors.Add(character);

		var mob0 = Shortcuts.AddMonster(0, 47103, "", "None", -479.37, 161.8, 395.19, 0);
		mob0.SetVisibilty(ActorVisibility.Track, character.ObjectId);
		mob0.AddEffect(new ScriptInvisibleEffect());
		mob0.Layer = character.Layer;
		actors.Add(mob0);

		var mob1 = Shortcuts.AddMonster(0, 155148, "", "None", 76.78, 165.09, 531.55, 0);
		...
		var mob14 = Shortcuts.AddMonster(0, 155145, "", "None", 90.44458, 165.0884, 489.1262, 37.91667);
		mob14.SetVisibilty(ActorVisibility.Track, character.ObjectId);
		mob14.AddEffect(new ScriptInvisibleEffect());
		mob14.Layer = character.Layer;
		actors.Add(mob14);

		var mob15 = Shortcuts.AddMonster(0, 20026, "", "None", -284.428, 163.9543, 463.5719, 0);
		...
		var mob16 = Shortcuts.AddMonster(0, 155149, "", "None", -705.72, 161.71, 415.37, 0);
		...
		var mob17 = Shortcuts.AddMonster(0, 20026, "", "None", 44.567, 165.0884, 512.2307, 0);
	...
	public override async Task OnProgress(Character character, Track track, int frame)
	{
		...
		{
			case 16:
				//DRT_ACTOR_ATTACH_EFFECT("I_light001", "TOP");
				break;
			case 39:
				//DRT_ACTOR_ATTACH_EFFECT("F_light091_dark_loop", "TOP");
				break;
			case 56:
				await track.Dialog.Msg("WHITETREES233_SQ_08_track1");
				break;
			case 60:
