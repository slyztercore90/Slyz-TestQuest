...
public class Quest8272Script : QuestScript
{
	protected override void Load()
	{
		...
		SetTrack(QuestStatus.Progress, QuestStatus.Success, "KATYN14_SUB_06_TRACK", 1000);

		AddPrerequisite(new LevelPrerequisite(9999));

		AddObjective("kill0", "Kill 6 Red Fisherman(s)", new KillObjective(6, MonsterId.Fisherman_Red));
