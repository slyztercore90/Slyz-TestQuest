...
public class Quest80231Script : QuestScript
{
	...
	{
		character.AddonMessage(AddonMessage.NOTICE_Dm_Clear, "You can now use the Mercenary Post!{nl}Press the F5 key to read the details in the Quest info window!");
	}
}
