	...
	private async Task<HookResult> BeforeStart(Dialog dialog)
	{
		...
		switch (await dialog.Select("F_3CMLAKE_86_MQ_03_ST", "F_3CMLAKE_86_MQ_03", "I will try my best", "I don't think it's going to work."))
		{
			case 1:
				...
				character.AddonMessage(AddonMessage.NOTICE_Dm_Scroll, "You've disguised yourself as a Schaffenstar member!{nl}Convince the neutral members of the Schaffenstar to join the Resistance!", 5);
