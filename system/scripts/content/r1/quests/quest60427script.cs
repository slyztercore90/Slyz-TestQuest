...
public class Quest60427Script : QuestScript
{
	...
	{
		character.AddonMessage(AddonMessage.NOTICE_Dm_Scroll, "More to the next region and use the Time Meter Necklace{nl}on the monsters, then find the Lost Pendant.");
	}
}
