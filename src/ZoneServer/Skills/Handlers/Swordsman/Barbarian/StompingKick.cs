...
namespace Melia.Zone.Skills.Handlers.Barbarian
{
	...
	public class StompingKick : IGroundSkillHandler
	{
		/// <summary>
		...
		public void Handle(Skill skill, ICombatEntity caster, Position originPos, Position farPos, ICombatEntity target)
		{
			...
			{
				Log.Warning("Stomping Kick: Player {0} cast skill farther than max range ({1} > {2}).", caster.Name, castRange, skill.Data.MaxRange);
				return;
			}
