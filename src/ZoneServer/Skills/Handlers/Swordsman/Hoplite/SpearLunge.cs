...
namespace Melia.Zone.Skills.Handlers.Hoplite
{
	...
	public class SpearLunge : IGroundSkillHandler
	{
		/// <summary>
		...
		public void Handle(Skill skill, ICombatEntity caster, Position originPos, Position farPos, ICombatEntity target)
		{
			...
			{
				Log.Warning("Spear Lunge: Player {0} cast skill farther than max range ({1} > {2}).", caster.Name, castRange, skill.Data.MaxRange);
				return;
			}
