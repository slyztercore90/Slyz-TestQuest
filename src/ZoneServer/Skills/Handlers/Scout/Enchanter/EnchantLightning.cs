...
{
	/// <summary>
	/// Handler for the Enchanter skill Enchant Lightning.
	/// </summary>
	[SkillHandler(SkillId.Enchanter_EnchantLightning)]
	public class EnchantLightning : IGroundSkillHandler
	{
		/// <summary>
		...
		public void Handle(Skill skill, ICombatEntity caster, Position originPos, Position farPos, ICombatEntity designatedTarget)
		{
			...
			var buff = new Buff(BuffId.EnchantLightning_Buff, 0, 0, TimeSpan.Zero, caster, caster);
