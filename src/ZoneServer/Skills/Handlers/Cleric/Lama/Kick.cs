...
{
	/// <summary>
	/// Handler for the Lama skill Kick.
	/// </summary>
	[SkillHandler(SkillId.Lama_Kick)]
	public class Kick : IGroundSkillHandler
	{
		/// <summary>
		...
		public void Handle(Skill skill, ICombatEntity caster, Position originPos, Position farPos, ICombatEntity designatedTarget)
		{
			...
			var buff = new Buff(BuffId.Lamakick_Buff, 0, 0, TimeSpan.FromSeconds(10), caster, caster);
			//buff.Skill = skill;
