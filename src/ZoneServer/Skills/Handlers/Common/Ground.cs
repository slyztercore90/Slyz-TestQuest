...
{
	/// <summary>
	/// Handles skills targeting the ground in front of the caster.
	/// </summary>
	[SkillHandler(SkillId.Common_vuvuzela, SkillId.Common_bubblewrap, SkillId.Common_shovel, SkillId.Common_metaldetector, SkillId.Common_dumbbell, SkillId.Common_BubbleStick)]
	public class GroundSkillHandler : IGroundSkillHandler
	{
		...
		/// <param name="targets"></param>
		private async void Attack(Skill skill, ICombatEntity caster, Position castPosition, Position targetPosition, ICombatEntity target)
		{
