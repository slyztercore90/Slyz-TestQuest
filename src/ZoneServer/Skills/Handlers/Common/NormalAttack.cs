...
{
	/// <summary>
	/// Handler for the Common skill Normal Attack.
	/// </summary>
	[SkillHandler(SkillId.Normal_Attack)]
	public class NormalAttack : IMeleeGroundSkillHandler
	{
		/// <summary>
		...
		public void Handle(Skill skill, ICombatEntity caster, Position originPos, Position farPos, IList<ICombatEntity> targets)
		{
			...
			{
				Log.Warning("NormalAttack: Player {0} cast skill farther than max range ({1} > {2}).", caster.Name, castRange, skill.Data.MaxRange);
